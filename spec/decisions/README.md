...
| [ADR-0004-mermaid-grupos-y-estilos-libres.md](ADR-0004-mermaid-grupos-y-estilos-libres.md) | Mermaid: `subgraph` de primera clase con caja **derivada** de sus hijos, pertenencia por puntero del hijo al padre y color libre en hex con migración perezosa | propuesto |
